...
public class CustomerDaoImpl implements ICustomerDao{
	...
	public void saveCustomer(Customer customer) {
		try {
			runner.update("insert into cst_customer(cust_name,cust_source,cust_industry,"
					+ "cust_level,cust_address,cust_phone)values(?,?,?,?,?,?)",
	...
	public Customer findCustomer(Long custId) {
		try {
			return runner.query("select * from cst_customer where cust_id = ? ",
